...
/**
 * This class is the Resp Location screen
 * It displays a table with the data of the locations
 */
public class RespLocationView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resp_location_view);
        ...
        tvAdminHardwareText.setText("Here you can see all hardware locations.");
        ...
        String getsensorsurl ="http://34.204.144.157/api.php?type=local_fd_get_units";
        ...
        JsonArrayRequest getSensorsArrayRequest = new JsonArrayRequest(Request.Method.GET, getsensorsurl,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        // Handle error
                        Log.d("getUnits", error.getLocalizedMessage());
                        Toast.makeText(getApplicationContext(), "error while reading local_fd_get_units", Toast.LENGTH_SHORT).show();
                    }
                });
